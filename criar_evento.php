                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul id="demo">
							<li>
                                <a href="form_fornecedor.html">Fornecedores</a>
                            </li>
                            <li>
                                <a href="form_custos.php">Custos</a>
                            </li>
							<li>
                                <a href="form_local.html">Locais para eventos</a>
                            </li>
                            <li>
                                <a href="form_atracoes.html">Atrações</a>
                            </li>
							<li>
                                <a href="form_custo_pessoal.php">Custo Pessoal</a>
                            </li>
                        </ul>
                    </li>
					 ...
					 <li>
                        ...
                        <ul id="consultar" class="collapse">
                            <li>
                                <a href="consulta_fornecedor.html">Fornecedores</a>
                            </li>
                            <li>
                                <a href="consulta_custos.html">Custos</a>
                            </li>
							<li>
                                <a href="consulta_local.html">Locais para eventos</a>
                            </li>
                            <li>
                                <a href="consulta_atracoes.html">Atrações</a>
                            </li>
							<li>
                                <a href="consulta_custo_pessoal.php">Custo Pessoal</a>
                            </li>
                        </ul>
                    </li>
                ...
                <!-- /.row -->
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<form class="form-horizontal" role="form" action="gravar_evento.php" method="post" >
							
									
								<div class="form-group">
									<div class="col-sm-7">
										<input type="text" class="form-control"  placeholder="Nome do evento" name="nome_festa">
									</div>
									<div class="col-sm-3">
										<input type="text" class="form-control"  placeholder="Quantidade de Pessoas" name="quantidade_pessoas">
									</div>
								</div>
