...
<!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.html">Hera</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
				   ...
				   <li>
                        ...
                        <ul id="usuarios" class="collapse">
                            <li>
                                <a href="../usuario/form_usuario.php">Cadastrar</a>
                            </li>
                            <li>
                                <a href="../usuario/consulta_usuario.php">Consultar</a>
                            </li>
                   ...
                   <li>
					 ...
					 <li class="active">
                        ...
                        <ul id="consultar">
                           <li>
                                <a href="consulta_fornecedor.php">Fornecedores</a>
                            </li>
                            <li>
                                <a href="consulta_custos.php">Custos</a>
                            </li>
							<li>
                                <a href="consulta_local.php">Locais para eventos</a>
                            </li>
                            <li>
                                <a href="consulta_atracoes.php">Atrações</a>
                            </li>
							<li>
