        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Alteração de Atração
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<?php
					...
					if(isset($_GET['id_atracao']))
					{
						$_SESSION['id_atracao'] = $_GET['id_atracao'];
					}
					
					$sql = "SELECT * FROM atracoes WHERE id_atracao = " .$_SESSION['id_atracao'];
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" role="form" data-toggle="validator" action="atualiza_atracao.php?id_atracao=<?php echo $_SESSION['id_atracao']; ?>" method="post">
							<?php
								if(isset($_GET['c']))
								{
									if($_GET['c'] == "erro")
							...
							?>  
							  <div class="form-group">
								<div class="col-sm-5">
								  <input type="text" class="form-control" placeholder="Nome" name="nome_atracao" value="<?php echo $resultado['nome_atracao']; ?>" autofocus required 
										data-error="Este campo é obrigatório." data-minlength="4">
								   <div class="help-block with-errors"></div>
								</div>
								<div class="col-sm-5">
								  <input type="text" class="form-control" placeholder="Preço" name="preco_atracao" id="preco" value="<?php echo $resultado['preco_atracao']; ?>" required 
							  ...
							  <div class="form-group">
								<div class="col-sm-3">
								  <input type="text" class="form-control" placeholder="Telefone" name="tel_atracao" id="telefone" value="<?php echo $resultado['tel_atracao']; ?>" required 
								...
								<div class="col-sm-3">
								  <input type="text" class="form-control" placeholder="Cidade" name="cidade_atracao" value="<?php echo $resultado['cidade_atracao']; ?>" required 
										data-error="Este campo é obrigatório." data-minlength="4">
								   <div class="help-block with-errors"></div>
								</div>
							  
								<div class="col-sm-4">
								  <input type="text" class="form-control"  placeholder="Estilo" name="estilo_atracao" value="<?php echo $resultado['estilo_atracao']; ?>" required 
										data-error="Este campo é obrigatório." data-minlength="2">
								   <div class="help-block with-errors"></div>
								</div>
							  </div>
							  ...
							  <div class="form-group">
								<div class="col-sm-10">
								  <textarea class="form-control" name="descricao_atracao" placeholder="Descrição da atração"> <?php echo $resultado['descricao_atracao']; ?></textarea>
								</div>
							  </div>
							  <div class="form-group">
								
								<div class="col-sm-10">
								  <textarea class="form-control" name="observacoes_atracao" placeholder="Observações"><?php echo $resultado['observacoes_atracao']; ?></textarea>
							  </div>
							  </div>
							  <div class="form-group">
								<div class="col-sm-3">
								...
								<div class="col-sm-3">
								  <a href="consulta_atracoes.php" class="btn btn-block btn-default">Cancelar</a>
								</div>
							  </div>
								<?php } ?>
                        </form>
