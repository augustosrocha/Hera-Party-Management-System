						...
						if(isset($_GET['a']))
						{
							if($_GET['a'] == "sucesso")
								echo "<div class='alert alert-success'>
										<strong>Sucesso!</strong> Local alterado com sucesso.
									</div>";
						}
						if(isset($_GET['b']))
						{
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Consulta de Locais
                            </li>
                        </ol>
                    </div>
                </div>
					...
					<?php
						...
						while($resultado = mysqli_fetch_assoc($query))
						{
							...
							<tr align="center">
								...
								<td> <a href='form_local_alterar.php?id_local=<?php echo $resultado['id_local']; ?>'><i class="glyphicon glyphicon-edit"></i></a> </td>
								<td> <a href='excluir_local.php?id_local=<?php echo $resultado['id_local']; ?>'><i class="glyphicon glyphicon-remove-sign"></i></a> </td>
							</tr>
							<?php
						}
