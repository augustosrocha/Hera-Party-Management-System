...
<?php
	...
	if($validator -> ValidateForm())
	{
		...
		$sql = "INSERT INTO `fornecedores`(`id_fornecedor`, `nome_fornecedor`, `cidade_fornecedor`, `tel_fornecedor`, `descricao_fornecedor`, `avaliacao_fornecedor`)VALUES (null,'".$nome_fornecedor."','".$cidade_fornecedor."', '".$tel_fornecedor."','".$descricao_fornecedor."', null)";
		...
		else
		{
			...
			header ("Location: form_fornecedor.php?b=sucesso");
		}
	...
	else
	{
		...
		foreach($error_hash as $inpname=>$inp_err)
		{
			...
			header ("Location: form_fornecedor.php?c=erro");
	}
