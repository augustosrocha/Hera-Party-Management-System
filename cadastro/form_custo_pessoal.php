            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Cadastro de Custo Pessoal
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" role="form" data-toggle="validator" action="cadastro_custo_pessoal.php" method="post">
							<?php
								if(isset($_GET['c']))
								{
									if($_GET['c'] == "erro")
